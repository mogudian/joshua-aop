...
public class AddQueryConditionInterceptor extends MybatisBaseInterceptor implements Interceptor {
     ...
     * 要加入的条件的指针
     */
    private final ThreadLocal<String> conditionHolder;

    public AddQueryConditionInterceptor(ThreadLocal<String> conditionHolder) {
    ...
    public Object intercept(Invocation invocation) throws Throwable {
        // 查看开关
        String condition = conditionHolder.get();
